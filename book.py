...
BOOK = [
 
    {
        ...
        "text": "You are Sir Aldric, a noble knight from the kingdom of Eldoria. The king has entrusted you with a perilous quest: to retrieve the legendary Dragon’s Hoard, a treasure hidden deep within the Necromancer’s cursed lands. Your journey begins in the bustling medieval town of Redhaven. Do you...",
        "options": [
    ...
    },
    {
        ...
        "options": [
            {"text": "Purchase a reinforced longsword.", "next_id": 4},
    ...
    },
    {
        ...
        "text": "You purchase the reinforced longsword. Gorin nods approvingly. 'A fine choice, knight. This blade will serve you well.' Feeling better prepared, you set off towards the haunted forest.",
        "options": [
